...
{
	public static ControllerState					GetCurrentState(this Animator ac, int layer) 	{ var hash = ac.GetCurrentAnimatorStateInfo(0).nameHash; return ac.GetStates().FirstOrDefault((arg) => hash == arg.hash); }
	...
	public static IEnumerable<string>				GetLayers(this Animator ac) 		{ return RuntimeAnimatorControllerExtensionData.GetLayers(ac.runtimeAnimatorController); }
